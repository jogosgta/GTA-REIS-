...
**Art direction:** mobile 3D open-world screenshot with an original Brazilian-inspired urban identity: midnight blue sky, teal streets and signage, amber lights, coral accents, crisp semi-realistic geometry, clean readable HUD, no copied characters, logos or assets.
